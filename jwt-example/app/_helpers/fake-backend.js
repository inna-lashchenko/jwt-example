...
function fakeBackendFactory(backend, options) {
    ...
    backend.connections.subscribe(function (connection) {
        ...
        setTimeout(function () {
            ...
            if (connection.request.url.endsWith('/api/getNews') && connection.request.method === http_1.RequestMethod.Post) {
                // Add functionality
            }
            if (connection.request.url.endsWith('/api/addNews') && connection.request.method === http_1.RequestMethod.Post) {
                // Add functionality
            }
